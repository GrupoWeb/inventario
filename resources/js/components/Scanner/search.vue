        ...
        >
          <el-form-item label="SICOIN" prop="name">
            <el-input
              ...
              autofocus
              ref="autoInput"
              @keyup.enter.native.prevent="enter_onSubmit()"
            ></el-input>
          </el-form-item>
          <el-form-item>
              ...
              <div class="bottom clearfix">
                <div v-for="(items, i) in listProduct" :key="i">
                  <el-row :gutter="10" class="mt-3">
                    ...
                    <el-col :xs="25" :sm="6" :md="8" :lg="5" :xl="3" >{{ items.codigo_sicoin}}</el-col>
                    <el-col :xs="25" :sm="6" :md="8" :lg="20" :xl="5"  >
                      <span class="font-weight-bold">Sistema:</span>
                    </el-col>
                    <el-col :xs="25" :sm="6" :md="8" :lg="20" :xl="3" >{{ items.cantidad}} Unidad</el-col>
                    <el-col :xs="25" :sm="6" :md="8" :lg="20" :xl="5"  >
                      <span class="font-weight-bold">Físico:</span>
                    </el-col>
                    <el-col :xs="25" :sm="6" :md="8" :lg="20" :xl="3" >{{ items.fisico}} Unidad</el-col>
                  </el-row>
                  ...
                  >
                    <el-form-item label="Físico:" prop="fisico">
                      <el-input
                        class="font_custom_input"
                        v-model="formInventory.fisico"
                        ref="form_fisico"
                      ></el-input>
                    </el-form-item>
                    ...
                    <el-form-item>
                      <el-button
                        type="primary"
                        @click.prevent="updateInventory('formInventory')"
                      >Guardar</el-button>
                      <el-button @click="reset">Cancel</el-button>
                    </el-form-item>
                  </el-form> -->
    ...
    updateInventory(form) {
      ...
      this.$refs[form][0].validate((valid) => {
        if (valid) {
            ...
            .then((response) => {
              ...
              if (status == "200") {
                if (response.data === false) {
                  this.$message.error({
                    message: h("p", null, [
                      h("i", { style: "color: red" }, "El bien ya se encuentra ingresado"),
                    ]),
                  });
                  this.reset();
                  return false;
          ...
          this.$message.error({
            message: h("p", null, [
              h("i", { style: "color: red" }, "Complete datos"),
            ]),
          });
          return false;
        }
